    ...
    private void AddAdministrator()
    {
        Task.Run(async () =>
        {
            ...
            var superUser = new User
            {
                ...
                Email = "administrador@fluxocaixa.com",
                UserName = "administrador@fluxocaixa.com",
                EmailConfirmed = true,
            ...
            {
                await _userManager.CreateAsync(superUser, "fluxocaixa@2023");
