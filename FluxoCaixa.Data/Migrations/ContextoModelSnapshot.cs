...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Data.Apoio.TipoTransacao", b =>
                {
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Data.Manutencao.Categoria", b =>
                {
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Data.Manutencao.Conta", b =>
                {
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Data.Operacional.Transacao", b =>
                {
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Data.Seguranca.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Data.Seguranca.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Data.Seguranca.UserRole", b =>
                {
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Data.Operacional.Transacao", b =>
                {
                    b.HasOne("FluxoCaixa.Models.Data.Manutencao.Categoria", "Categoria")
                        .WithMany()
                        .HasForeignKey("CategoriaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FluxoCaixa.Models.Data.Manutencao.Conta", "Conta")
                        .WithMany()
                        .HasForeignKey("ContaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FluxoCaixa.Models.Data.Apoio.TipoTransacao", "TipoTransacao")
                        .WithMany()
            ...
            modelBuilder.Entity("FluxoCaixa.Models.Data.Seguranca.UserRole", b =>
                {
                    b.HasOne("FluxoCaixa.Models.Data.Seguranca.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FluxoCaixa.Models.Data.Seguranca.User", null)
                        .WithMany()
