...
using FluxoCaixa.Services.Security;
using FluxoCaixa.Models.Data.Seguranca;
using FluxoCaixa.Services.Operacional;
using FluxoCaixa.Models.Security;
using NuvTools.Common.ResultWrapper;
using FluxoCaixa.Services.Manutencao;
using Microsoft.AspNetCore.Builder;
using System.Globalization;
using FluxoCaixa.Services.Apoio;
...
public static class ServiceCollectionExtensions
{
    ...
    private static void RegisterSwagger(this IServiceCollection services)
    {
        ...
        {
            c.IncludeXmlComments(string.Format(@"{0}\FluxoCaixa.API.xml", AppDomain.CurrentDomain.BaseDirectory));
